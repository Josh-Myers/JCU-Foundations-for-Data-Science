...
These population-level data were used with the ARDD dataset to create proportions for various categories, in order to identify groups with higher risk of death, for example, by comparing the proportion of young men aged 20 to 25 who died in motorvehicle accidents with the proportion of young men that age in the general population. Exactly how these additional datasets were used is described in the Methods section. 
...
Heavy Rigid Truck had 20,493 missing values, but I only use data from 2018 for this variable in this analysis, of which none were missing, so this variable was left as is. 
...
Figure 1 shows the distribution of the variables Year, Month, Day of the Week, Hour of the Day, Age, Gender, State, and Type of Road User. Notice that the number of deaths have decreased over time (Year), and Friday to Sunday have a higher number of deaths than other days of the week. The afternoon appears to be the most dangerous time, with density peaking at 3 pm, with a secondary peak at around midnight. Young people seem to be more at risk of dying, with the distribution for age peaking at around 20 years, and males appear to be more at risk of dying, with more than twice as many males dying than females. The plot for state generally shows that the number of deaths decreases as state population decreases, with the exception of the Northern Territory, which although has the smallest population, has more deaths than the ACT and Tasmania. Buses were involved in 941 deaths, and articulated trucks were involved in 5071 deaths. Heavy rigid trucks were involved in 1400 deaths, although, as mentions, there were many missing values for this variable (>20,000). 
...
prop_p_100k_sex_age = ggplot(death_pop_states, aes(x=Year, y=death_prop_per_10k, colour=State)) + 
  ...
  scale_y_log10() +
  facet_grid(age_cat~Gender)
plot(prop_p_100k_sex_age) # NT young people especially males are overrepreseted
```
