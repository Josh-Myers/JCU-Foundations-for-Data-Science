...
proportion of population each age in 2016: https://profile.id.com.au/australia/five-year-age-groups - This is referred to as the "age dataset" in this report. 
...
```{r fig1, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig1}Plots exploring the distributions of the variables Year, Month, Day, Hour, Age, Gender, State, and Road User "}
...
```{r fig2, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig2}The number of deaths in each State from 1989 to 2018 grouped by Age Group and Gender."}
# Fig 1
...
```{r fig3, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig3}The number of deaths per 100,000 people for each State from 1989 to 2018 grouped by Age Group and Gender."}
...
```{r fig4, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig4}The number of deaths for each age group and gender from 1989 to 2018."}
# Fig 3, age plot
...
```{r fig7, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig7}The number of deaths in by hour of the day for each five-year interval for each age group and gender."}
# Fig 6
...
```{r fig8, echo=F, fig.width=7, fig.height=6, fig.cap="\\label{fig:fig8}The number of deaths in each hour of the day for each day of the week for each five-year interval for each age group and gender."}
# fig 7
