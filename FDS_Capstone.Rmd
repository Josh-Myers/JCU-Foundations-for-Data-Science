...
year_p = ggplot(road_data, aes(Year)) +
  geom_density()
year_p
month_p = ggplot(road_data, aes(as.integer(Month))) +
  geom_density()
month_p
...
time_p = ggplot(road_data, aes(time_of_day)) +
  geom_density()
time_p
road_user_p = ggplot(road_data, aes(road_user)) +
  geom_bar()
road_user_p
bus_p  = ggplot(road_data, aes(bus_involve)) +
  geom_bar()
bus_p
truck_p  = ggplot(road_data, aes(heavy_rigid_involve)) +
  geom_bar()
truck_p
articulated_p  = ggplot(road_data, aes(articulated_involve)) +
  geom_bar()
articulated_p
```
Need distribution plots of all variables - looks like young people and males are overrepreseted? No obvious outliers that need attention. 
